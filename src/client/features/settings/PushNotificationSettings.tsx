...
export function PushNotificationSettings(): React.JSX.Element {
  ...
  return (
    <section className="settings-section push-settings">
      ...
      <p>
        AI מנתח את היום שלך מול אתמול ומכוון לצעד הבא. לקראת סוף השבוע הוא מסתכל גם על כל השבוע
        ומחפש את הדפוס שהכי כדאי לקחת איתך לסופ״ש.
      </p>
      ...
      <div className="profile-form">
        ...
        <div className="status-message">
          ...
          <br />
          <small>
            כל התראה נוצרת ומנותחת באמצעות AI. אם ה־AI אינו זמין, לא תישלח הודעה כללית או אוטומטית
            במקומו.
          </small>
        </div>
