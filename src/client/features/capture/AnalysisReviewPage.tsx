      ...
      <section className="page-title">
        ...
        <p>
          {isManualEntry
            ...
            : isTextEntry
              ? "הזיהוי והערכים התזונתיים הגיעו ישירות מה-AI לפי הטקסט. המאגר לא משנה אותם אוטומטית; אפשר לבחור מוצר ידנית רק אם תרצה."
          ...
          <div>
            ...
            <p>
              {textAnalysisFallback
                ...
                : `נמצאו ${items.length} רכיבים. הערכים הוערכו ישירות מהטקסט באמצעות AI, ללא התאמה אוטומטית למאגר.`}
            </p>
